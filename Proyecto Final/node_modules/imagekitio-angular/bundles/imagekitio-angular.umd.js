(function (global, factory) {
	...
	(factory((global['imagekitio-angular'] = {}),global.ng.core));
...
IkImageComponent.propDecorators = {
    ...
    'urlEndpoint': [{ type: core.Input, args: ['urlEndpoint',] },],
    'transformation': [{ type: core.Input, args: ['transformation',] },],
    'transformationPosition': [{ type: core.Input, args: ['transformationPosition',] },],
    'queryParameters': [{ type: core.Input, args: ['queryParameters',] },],
    'lqip': [{ type: core.Input, args: ['lqip',] },],
};
...
IkUploadComponent.propDecorators = {
    'fileName': [{ type: core.Input, args: ['fileName',] },],
    'useUniqueFileName': [{ type: core.Input, args: ['useUniqueFileName',] },],
    'tags': [{ type: core.Input, args: ['tags',] },],
    'folder': [{ type: core.Input, args: ['folder',] },],
    'isPrivateFile': [{ type: core.Input, args: ['isPrivateFile',] },],
    'customCoordinates': [{ type: core.Input, args: ['customCoordinates',] },],
    'responseFields': [{ type: core.Input, args: ['responseFields',] },],
    'onError': [{ type: core.Output },],
    'onSuccess': [{ type: core.Output },],
    'onFileInput': [{ type: core.Input },],
};
...
exports.ɵa = ImageKitConfiguration;
exports.ɵb = ImagekitService;
